...
Languages and Tools:
Angular | Bootstrap | C# | Chartjs | CSS | Express | Figma | firebase | git | html | Javascript | TypeScript | Material UI | MongoDB | SQL | Nextjs | Nodejs | Postman | React | Reactnative | Sass | Tailwind 
